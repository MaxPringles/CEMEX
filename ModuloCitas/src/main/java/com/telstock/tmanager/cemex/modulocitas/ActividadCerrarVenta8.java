 ...
 */
public class ActividadCerrarVenta8 extends Fragment
    ...
    private RadioButton radioAceptada;
    private RadioButton radioDeclinada;
    private Button btnCitasVerPropuesta;
    private Button btnCitas8;
    private EditText etxComentarios;
    private LinearLayout layoutRespuestaCliente;
    ...
    private LinearLayout layoutAceptada;
    private LinearLayout layoutDeclinada;
    private Spinner spMotivosExclusion;
    private LinearLayout layoutCheckBoxOfertaIntegral;

    private EditText etComentariosDescartar;
    private ApiInterface apiInterface;
    private EditText etxFolio;
    private EditText etxHolding;
    ...
    private static final String ID_BOTON_8_REAGENDAR = "idBoton8Reagendar";
    private static final String ID_BOTON_8_CERRAR_VENTA = "idBoton8CerrarVenta";
    ...
    ArrayList<String> motivosExclusionDesc = new ArrayList<>();
    List<CatalogoStatusObraDB> estatusObraListAll = new ArrayList<>();
    List<CatalogoMotivoExclusionDB> motivosExclusionListAll = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.actividad_cerrar_venta_8, container, false);
        ...
        ((AppCompatActivity) context).getSupportActionBar().setTitle(getString(R.string.citas8_title));
        ...
        radioAceptada = (RadioButton) view.findViewById(R.id.radioAceptada);
        radioDeclinada = (RadioButton) view.findViewById(R.id.radioDeclinada);
        btnCitasVerPropuesta = (Button) view.findViewById(R.id.btn_citas8_ver_propuesta);
        btnCitas8 = (Button) view.findViewById(R.id.btn_citas8);
        etxComentarios = (EditText) view.findViewById(R.id.etx_comentarios);
        layoutRespuestaCliente = (LinearLayout) view.findViewById(R.id.layout_respuesta_cliente);
        layoutAceptada = (LinearLayout) view.findViewById(R.id.layout_aceptada);
        layoutDeclinada = (LinearLayout) view.findViewById(R.id.layout_declinada);
        spMotivosExclusion = (Spinner) view.findViewById(R.id.spMotivos);

        etxFolio = (EditText) view.findViewById(R.id.etxFolio);
        etxHolding = (EditText) view.findViewById(R.id.numHolding);
...
//        spEstatusObra = (Spinner) view.findViewById(R.id.sp_estatus_obra);
        ...
        radioAceptada.setOnClickListener(this);
        radioDeclinada.setOnClickListener(this);
        btnCitasVerPropuesta.setOnClickListener(this);
        btnCitas8.setOnClickListener(this);
    ...
    public void cargarSpinner() {
        ...
        motivosExclusionListAll = CatalogoMotivoExclusionRealm.mostrarListaMotivoExclusion();
        motivosExclusionDesc.add(getString(R.string.formulario_spinners_default));
        for (CatalogoMotivoExclusionDB motivoExclusion : motivosExclusionListAll) {
            motivosExclusionDesc.add(motivoExclusion.getDescripcion());
        }

        adapter = new ArrayAdapter<>(context, R.layout.spinner_style, estatusObraDesc);
//        spEstatusObra.setAdapter(adapter);
        adapter = new ArrayAdapter<>(context, R.layout.spinner_style, motivosExclusionDesc);
        spMotivosExclusion.setAdapter(adapter);
    }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.radioSi) {
            layoutRespuestaCliente.setVisibility(View.VISIBLE);
            layoutSi.setVisibility(View.VISIBLE);
            btnCitas8.setText("CERRAR VENTA");
        } else if (v.getId() == R.id.radioNo) {
            layoutRespuestaCliente.setVisibility(View.VISIBLE);
            layoutSi.setVisibility(View.GONE);
            btnCitas8.setText("REAGENDAR ACTIVIDAD");
        } else if (v.getId() == R.id.radioAceptada) {
            layoutAceptada.setVisibility(View.VISIBLE);
            layoutDeclinada.setVisibility(View.GONE);
        } else if (v.getId() == R.id.radioDeclinada) {
            layoutAceptada.setVisibility(View.GONE);
            layoutDeclinada.setVisibility(View.VISIBLE);
        ...
        } else if (v.getId() == R.id.btn_citas8_ver_propuesta) {

            dialogModal = AlertDialogModal.showModalTwoButtons(context, this,
                    "Agendar Actividad", "Recibir Respuesta",
                    getString(R.string.citas_dialog_confirmar), getString(R.string.citas_dialog_cancelar), ID_VER_PROPUESTA);

        } else if (v.getId() == R.id.btn_citas8) {
            if (validarCampos()) {

                if (btnCitas8.getText().toString().equals("REAGENDAR ACTIVIDAD")) {
                    dialogModal = AlertDialogModal.showModalTwoButtons(context, this,
                            "Agendar Actividad", getString(R.string.citas8_title),
                            getString(R.string.citas_dialog_confirmar), getString(R.string.citas_dialog_cancelar), ID_BOTON_8_REAGENDAR);
                } else {

                    showProgress(); //Se muestra el ProgressDialog.

                    if (radioAceptada.isChecked()) {
                        actualizarNumeroObra();
                    } else {
                        obraPerdida();
                    }
                }
            ...
            if (checkboxDescartar.isChecked()) {
                ...
                layoutRespuestaCliente.setVisibility(View.GONE);
            } else {
    ...
    public void actualizarNumeroObra() {
        Gson gson = new Gson();
        ...
        try {
            ...
            jsonObra.setNumeroObra(etxFolio.getText().toString());
            jsonObra.setmNumeroHolding(etxHolding.getText().toString());
        ...
        putObra.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.code() == 200) {
                    llenarObjetoParcialmente(Valores.ID_ACTIVIDAD_CERRAR_VENTA, Valores.ID_ESTATUS_PROSPECTO_GANADA, true);
    ...
    public void obraPerdida() {

        ProspectoPerdido prospectoPerdido = new ProspectoPerdido();

        MotivoExclusion motivoExclusion = new MotivoExclusion();
        motivoExclusion.setId(motivosExclusionListAll.get(spMotivosExclusion.getSelectedItemPosition() - 1).getId());
        motivoExclusion.setComentarios(etxComentarios.getText().toString());

        prospectoPerdido.setIdProspecto(prefs.getString(Valores.SHAREDPREFERENCES_ID_PROSPECTO, ""));
        prospectoPerdido.setMotivoExclusion(motivoExclusion);

        Call<ResponseBody> putMotivoExclusion = apiInterface.putMotivoExclusion(prospectoPerdido);

        putMotivoExclusion.enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.code() == 200) {
                    llenarObjetoParcialmente(Valores.ID_ACTIVIDAD_CERRAR_VENTA, Valores.ID_ESTATUS_PROSPECTO_PERDIDA, true);
                } else if (response.code() == Valores.TOKEN_EXPIRADO) {
                    //Muestra diálogo indicando que la sesión ha expirado y devuelve al Login.
                    AlertTokenToLogin.showAlertDialog(context);
                } else {
                    Toast.makeText(context, "La obra no se pudo actualizar", Toast.LENGTH_LONG).show();
                    llenarObjetoParcialmente(Valores.ID_ACTIVIDAD_CERRAR_VENTA, Valores.ID_ESTATUS_PROSPECTO_PERDIDA, true);
                }
            }
...
//        }
        ...
        if (radioAceptada.isChecked()) {
            if (etxFolio.getText().toString().isEmpty()) {
                Toast.makeText(context, getString(R.string.citas_folio), Toast.LENGTH_SHORT).show();
                etxFolio.requestFocus();
                return false;
            }
            if (Long.parseLong(etxFolio.getText().toString()) < 65000000 || Long.parseLong(etxFolio.getText().toString()) > 70000000) {
                Toast.makeText(context, getString(R.string.citas_folio_incorrecto), Toast.LENGTH_SHORT).show();
                etxFolio.requestFocus();
                return false;
            }

            if (etxHolding.getText().toString().isEmpty()) {
                Toast.makeText(context, getString(R.string.citas_holding), Toast.LENGTH_SHORT).show();
                etxHolding.requestFocus();
                return false;
            }
            if (Long.parseLong(etxHolding.getText().toString()) < 50000000 || Long.parseLong(etxHolding.getText().toString()) > 59000000) {
                Toast.makeText(context, getString(R.string.citas_holding_incorrecto), Toast.LENGTH_SHORT).show();
                etxHolding.requestFocus();
                return false;
            }

        } else {
            if (spMotivosExclusion.getSelectedItemPosition() == 0) {
                Toast.makeText(context, getString(R.string.citas_motivos_exclusion_empty), Toast.LENGTH_SHORT).show();
                spMotivosExclusion.requestFocus();
                return false;
            }
        }
    ...
    public void alertDialogPositive(String idDialog) {
        ...
        switch (idDialog) {
            ...
            case ID_FORMULARIO_SERVICIO:
                ...
                break;
            case ID_BOTON_8_REAGENDAR:

                if (revisarAlMenosUnProductoSeleccionado(listaSubsegmento, listaServicios)) {
                    estatusActividad = 2;
                    llenarObjetoParcialmente(Valores.ID_ACTIVIDAD_NEGOCIAR_AJUSTAR_PROPUESTA, Valores.ID_ESTATUS_PROSPECTO_EN_NEGOCIACION, false);
...
//                motivoExclusion.setId(estatusObraListAll.get(spEstatusObra.getSelectedItemPosition() - 1).getId());
    ...
    public void guardarFolio() {
        ...
        tinyDB.putString(Valores.SHAREDPREFERENCES_FOLIO, etxFolio.getText().toString());
        tinyDB.putString(Valores.SHAREDPREFERENCES_HOLDING, etxHolding.getText().toString());
    }
...
//                    }
    ...
    public int evaluarPasoActual() {
        ...
        int idActividadActual = Valores.ID_ACTIVIDAD_NEGOCIAR_AJUSTAR_PROPUESTA;
    ...
    public void llenarObjetoParcialmente(int idActividad, int idEstatusProspecto, boolean cerrada) {
...
//            }
            ...
            jsonAltaActividades.setIdPaso(5);
        ...
        sendActividadAlta.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.code() == 200) {
                    ...
                    if (radioAceptada.isChecked()) {
                        ...
                        try {
                            dialogModal = AlertDialogModal.showModalOneButton(context, comunicarAlertDialog,
                                    "CONFIRMACIÓN", "Se GANÓ la Venta con Número de Registro " + tinyDB.getString(Valores.SHAREDPREFERENCES_FOLIO),
                                    getString(R.string.citas_dialog_confirmar), ID_BOTON_8_CERRAR_VENTA);
                        } catch (Exception e) {
                            dialogModal = AlertDialogModal.showModalOneButton(context, comunicarAlertDialog,
                                    "CONFIRMACIÓN", "Se ha GANADO la Venta",
                                    getString(R.string.citas_dialog_confirmar), ID_BOTON_8_CERRAR_VENTA);
                        }
                    } else {
                        try {
                            dialogModal = AlertDialogModal.showModalOneButton(context, comunicarAlertDialog,
                                    "CONFIRMACIÓN", "Se PERDIÓ la Venta con Número de Registro " + tinyDB.getString(Valores.SHAREDPREFERENCES_FOLIO),
                                    getString(R.string.citas_dialog_confirmar), ID_BOTON_8_CERRAR_VENTA);
                        } catch (Exception e) {
                            dialogModal = AlertDialogModal.showModalOneButton(context, comunicarAlertDialog,
                                    "CONFIRMACIÓN", "Se ha PERDIDO la Venta",
                                    getString(R.string.citas_dialog_confirmar), ID_BOTON_8_CERRAR_VENTA);
                        }
                    }
                    ...
                    Snackbar.make(view, getString(R.string.plan_time_picker_fail_cerrar), Snackbar.LENGTH_LONG).show();
