...
import com.telstock.tmanager.cemex.prospectos.adapters.AdapterVerExpediente;
...
public class ArchivosFragmentDescarga extends Fragment implements View.OnClickListener, OnClickDescarga {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewDescarga.addItemDecoration(new DividerItemDecoration(context));
    ...
    public void getImagenesSubidas(String imagenesSubidas) {
        if (imagenesSubidas.equals(getString(R.string.uploader_ok))) {
            obtenerArchivosProspecto();
        }
    }
