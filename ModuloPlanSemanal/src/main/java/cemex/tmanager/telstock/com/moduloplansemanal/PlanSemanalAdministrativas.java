...
public class PlanSemanalAdministrativas extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        txtSeleccionarActividad.setText(getString(R.string.plan_tipo_administrativas_title));
        ...
        catalogoActividadesPGVDBList = CatalogoActividadesPGVRealm.mostrarActividadesIdPadre(Valores.ID_PADRE_ACTIVIDADES_ADMINISTRATIVAS);
