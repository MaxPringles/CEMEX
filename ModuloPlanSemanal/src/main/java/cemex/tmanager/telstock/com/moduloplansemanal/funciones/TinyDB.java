package cemex.tmanager.telstock.com.moduloplansemanal.funciones;
...
public class TinyDB {
    ...
    /** MÉTODO QUE RECUPERA EL OBJETO JsonAltaActividadesAdministrativas **/
    public JsonAltaActividadesAdministrativas getJsonAltaActividadesAdministrativas(String key, Class<JsonAltaActividadesAdministrativas> classOfT){

        String json = getString(key);
        JsonAltaActividadesAdministrativas value = new Gson().fromJson(json, classOfT);
        if (value == null)
            throw new NullPointerException();
        return value;
    }

    /** MÉTODO QUE RECUPERA EL OBJETO Pr
     * oducto **/
    ...
    /*public List<SubsegmentosProducto> getSubsegmentosProductosList(String key, Class<?> mClass){
        Gson gson = new Gson();
    ...
    /*public void putSubsegmentosProductosList(String key, List<SubsegmentosProducto> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
    ...
    /** MÉTODO QUE GUARDA EL OBJETO JsonAltaActividadesAdministrativas **/
    public void putJsonAltaActividadesAdministrativas(String key, JsonAltaActividadesAdministrativas obj){
        checkForNullKey(key);
        Gson gson = new Gson();
        putString(key, gson.toJson(obj));
    }
